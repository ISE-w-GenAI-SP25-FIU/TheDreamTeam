...
# Mock data
users = {
    'user1': {'full_name': 'John Doe', 'profile_image': 'https://example.com/johndoe.jpg'},
    'user2': {'full_name': 'Jane Smith', 'profile_image': 'https://example.com/janesmith.jpg'},
}

# Mock posts data
mock_posts_data = [
    {'user_id': 'user1', 'timestamp': '2024-01-01 12:00:00', 'content': 'Had a great workout!', 'image': None},
    {'user_id': 'user2', 'timestamp': '2024-01-02 14:30:00', 'content': 'Feeling strong!', 'image': 'https://example.com/image.jpg'},
]

# Mock workout data
mock_workouts_data = [
    {'start_timestamp': '2024-01-01 08:00:00', 'end_timestamp': '2024-01-01 09:00:00', 'distance': 5.0, 'steps': 5000, 'calories_burned': 200},
    {'start_timestamp': '2024-01-02 10:00:00', 'end_timestamp': '2024-01-02 11:00:00', 'distance': 4.2, 'steps': 4500, 'calories_burned': 180},
]

# Mock GenAI advice data
mock_genai_advice = {'timestamp': '2024-01-01 12:00:00', 'content': 'Keep going!', 'image': None}
...
class TestDisplayPost(unittest.TestCase):
    ...
    def test_display_username(self):
        ...
        for user in users.keys():
            posts_data = mock_posts_data  # Replaced the real get_user_posts call with mock data
...
class TestDisplayActivitySummary(unittest.TestCase):
    ...
    def test_header(self):
        ...
        workout_data = mock_workouts_data  # Replaced the real get_user_workouts call with mock data
...
class TestDisplayGenAiAdvice(unittest.TestCase):
    ...
    def test_css_styling(self):
        ...
        advice_data = mock_genai_advice  # Replaced the real get_genai_advice call with mock data
    ...
    def test_advice_text(self):
        ...
        actual_line = at.markdown[1].value.strip().split('\n')[2].strip()
        assert actual_line == f"<p>{advice_text}</p>", "Incorrect advice text for GenAI Advice"
    ...
    def test_timestamp_text(self):
        ...
        actual_line = at.markdown[1].value.strip().split('\n')[3].strip()
        print(at.markdown[1].value.strip().split('\n')[3].strip())
        expected_line = '<p><em>2024-01-01 12:00:00</em></p>'
        ...
        assert not at.exception
        actual_line = at.markdown[1].value.strip().split('\n')[3].strip()
        assert actual_line == '<p></p>', "Timestamp should not exist when one isn't given for GenAI Advice"
    ...
    def test_motivational_image(self):
        ...
        actual_line = at.markdown[1].value.strip().split('\n')[4].strip()
        assert actual_line in valid_image_line or actual_line == "<p></p>", "Incorrect image for GenAI Advice"
